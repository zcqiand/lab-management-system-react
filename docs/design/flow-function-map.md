...
| 功能 ID | 为什么合法 |
|---|---|
| M01.F04.I01 | 动态菜单下发（前端静态 MENU_TREE；旧 SSR/CSR mix 时不再需要服务端 /auth/menus 轮询） |
...
| M03.F01.I07 | 试验流程 S01 接样 — ext 字段补录（接样收完字段后再扩） |
