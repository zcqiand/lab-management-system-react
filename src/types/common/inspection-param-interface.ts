 ...
 * 走 shared 契约路径 `/api/param-interfaces` 和 `/api/param-interfaces/links`（REQ-2026-001 收敛）。
 */
...
export interface ParamInterfaceLink {
  ...
  paramInterfaceCode: string   // REQ-2026-001：对齐契约字段（DB 列 param_interface_code）
  /**
